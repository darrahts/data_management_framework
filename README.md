...
2. make [setup_database.sh](setup_database.sh) executable and [install_timescale.sh](install_timescale.sh) executable as well (if desired).  `chmod +x setup_database.sh  && chmod +x install_timescale.sh`
